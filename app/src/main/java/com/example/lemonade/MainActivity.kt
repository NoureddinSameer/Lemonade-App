...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        when(lemonadeState) {
            SELECT ->{
//              lemonTree is an object from Class LemonTree
    ...
    //  I call setViewElements() to set the text and the picture
        setViewElements()
    }
    ...
    private fun setViewElements(){
        ...
        lemonImage?.contentDescription = squeezeCount.toString()
        when(lemonadeState){
            SQUEEZE -> {
                showSnackbar()
                lemonImage?.contentDescription = squeezeCount.toString()
            }else -> {
                lemonImage?.contentDescription = lemonadeState.toString()
            }
        }
    }
